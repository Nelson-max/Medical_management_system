module.exports = newToken => {
  const url = `${process.env.RESET_URL}/${newToken}`;
  const message = `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="content">
          <div class="parent">
            <div class="row1">
                <p class="">Medica <span>Store</span></p>
            </div>
          </div>
          <div class="row2">
          <p>Hi ,</p><br>
            ...
            limit has expired, you will have to resubmit the request for a password reset.</p>
            ...
            <p><i>We are happy to have you on board! Please reply to this email if you have any comments, questions or feedback.<br><br>
                ...
                Medical store management system Group 2</p></i>
          </div>
